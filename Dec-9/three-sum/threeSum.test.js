...
describe('threeSum', () => {
  it('should return first triplet adding up to a given target sum.', () => {
    expect(threeSum([10, 12, 12, 15, 12], 37)).toEqual([[10, 12, 15], [10, 12, 15], [10, 15, 12]]);
    expect(threeSum([4, 3, 2, 1, 0, -1, -2], 3)).toEqual([[4, 1, -2], [4, 0, -1], [3, 2, -2], [3, 1, -1], [2, 1, 0]]);
    expect(threeSum([5, 3, 2, 1, 0, -1, -2], 3)).toEqual([[5, 0, -2], [3, 2, -2], [3, 1, -1], [2, 1, 0]]);
  });
